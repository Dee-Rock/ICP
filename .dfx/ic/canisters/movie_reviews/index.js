...
import { idlFactory } from './movie_reviews.did.js';
export { idlFactory } from './movie_reviews.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MOVIE_REVIEWS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./movie_reviews.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the movie_reviews canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./movie_reviews.did.js")._SERVICE>}
 */
export const movie_reviews = createActor(canisterId);
