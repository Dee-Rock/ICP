...
import { idlFactory } from './cine_token.did.js';
export { idlFactory } from './cine_token.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CINE_TOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cine_token.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cine_token canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cine_token.did.js")._SERVICE>}
 */
export const cine_token = createActor(canisterId);
