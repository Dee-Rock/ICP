...
import { idlFactory } from './cineai_frontend.did.js';
export { idlFactory } from './cineai_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CINEAI_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cineai_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cineai_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cineai_frontend.did.js")._SERVICE>}
 */
export const cineai_frontend = createActor(canisterId);
